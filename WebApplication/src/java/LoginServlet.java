...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Bài tập 2</title>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String inform ="You must login";
        if(loginSuccess){ inform = "Welcome " + username;
    ...
    private boolean checkLogin(String username, String password) {
        ...
        try ( FileReader reader = new FileReader("C:\\Users\\Admin\\Documents\\NetBeansProjects\\WebApplication\\build\\web\\users.json")) {
